...
var POKEDEX_ENTRIES = {
  ...
  7: {
    ...
    fact: "В Эпизоде 8 Сквиртл Ромуса научился у Лапраса новой атаке — Ледяному Лучу (Ice Beam). А в Эпизоде 20 он эволюционирует в Вартортла, когда по команде Ромуса ставит большую водяную стену."
  },
  10: {
    owner: "kristi",
    ...
    fact: "В Эпизоде 8 Кристи нашла Катерпи на камне посреди реки — промёрзшего и напуганного. Она согрела его курткой и Пикачу. А когда вся команда уже перешла реку, Катерпи полз за ними по берегу — и сам ткнулся носом в её покебол. Так он добровольно выбрал Кристи."
  },
  12: {
    owner: "kristi",
    ...
    fact: "У Баттерфри три стадии: гусеница Катерпи → кокон Метапод → бабочка Баттерфри. Катерпи Кристи (поймана в Эпизоде 8) — в будущем станет Баттерфри. Целое превращение, как в реальной природе!"
  },
  17: {
    owner: "makster",
  ...
  63: {
    ...
    fact: "В Эпизоде 10 Ромус замечает, что Абра телепортируется всегда на одно и то же расстояние в сторону тени — находит закономерность и ловит хитростью. А потом Абра сам решает пойти с Ромусом."
  },
  131: {
